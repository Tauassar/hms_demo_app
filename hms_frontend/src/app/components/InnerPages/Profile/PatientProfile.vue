    ...
    <div class="profile-body">
        <div class="body-heading border-bottom">
            ...
            <div class="profile-heading-text">
                ...
                <div class="personal-data">
                    ...
                    <div class="data_row">
                        <h2>Адрес:</h2>
                        <span>{{user_data.contacts.address}}</span>
                    </div>
                    <div class="data_row">
                        <h2>Email:</h2>
        ...
        <div class="body-text border-bottom">
            <div class="appointments">
                ...
                <h2>
                    {{`Последнее обращение ${user_data.last_appointment}`||'Обращения отсутствуют'}}
                </h2>
            </div>
        ...
        <div class="body-text">
            ...
            <div class="data_row">
                <h2>Статус:</h2>
                <span>{{user_data.medical_status.status}}</span>
            </div>
            <div class="data_row">
                <h2>Группа крови:</h2>
                <span>{{user_data.medical_status.blood_group}}</span>
            </div>
            <div class="data_row">
                <h2>Статус вакцинации:</h2>
                <span>{{user_data.medical_status.vaccination_status}}</span>
            </div>
            <div class="data_row">
                <h2>Аллергии:</h2>
                <span>{{user_data.medical_status.allergies||'Отсуствуют'}}</span>
            </div>
        </div>
        <div class="body-text">
